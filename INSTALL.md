...
4. Start the server:
   ...
   uv run python -m immich_mcp.server

   # HTTP mode (for web dashboard)
   uv run uvicorn immich_mcp.server:app --port 10839
   ```
5. Open `http://localhost:10839` or the frontend URL.
...
| Something else | [Open a GitHub issue](https://github.com/sandraschi/immich-mcp/issues) |
