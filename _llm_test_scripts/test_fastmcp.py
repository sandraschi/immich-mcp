...
async def run_all_tests():
    print("Testing FastMCP 2.14.3 SOTA updates for ImmichMCP...")
    ...
    if success:
        ...
        print("- Agentic Immich workflow orchestration")
        print("- Intelligent photo processing")
        print("- Conversational Immich assistant")
    else:
