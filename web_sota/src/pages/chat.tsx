    ...
    return (
        <div className="flex h-[calc(100vh-8rem)] flex-col space-y-4">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold tracking-tight text-white">Immich AI Assistant</h2>
            ...
            <Card className="flex-1 border-slate-800 bg-slate-950/50 flex flex-col overflow-hidden">
                <CardContent className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 space-y-1">
                            ...
                            <p className="text-sm text-slate-300 bg-slate-900/50 p-3 rounded-md border border-slate-800 inline-block">
                                Can you find pictures of Benny playing in the snow?
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3">
                        ...
                        <div className="flex-1 space-y-1">
                            <div className="flex items-center gap-2">
                                <span className="text-sm font-medium text-blue-400">Immich AI</span>
                                <span className="text-xs text-slate-500">10:42 AM</span>
                            </div>
                            <div className="text-sm text-slate-300 bg-blue-950/10 p-3 rounded-md border border-blue-900/30 inline-block">
                                <p>Searching your Immich library for 'Benny playing in the snow'...</p>
                                <br />
                                <p className="font-mono text-emerald-400 text-xs">
                                    {">"} SEARCH_TYPE: CLIP (Semantic)<br />
                                    {">"} MATCHES_FOUND: 12<br />
                                    {">"} HIGHEST_SCORE: 0.85
                                </p>
                            </div>
                ...
                <div className="p-4 border-t border-slate-800 bg-slate-900/30">
                    <div className="flex gap-2">
                        <input
                            ...
                            placeholder="Ask Immich AI to find photos or manage albums..."
                        />
